			...
			if (selectedItemTag != newlySelectedItemTag) {
				...
				if (firstFragmentTag != newlySelectedItemTag) {
					...
					fragmentManager.beginTransaction()
						.setCustomAnimations(
							cz.cleevio.core.R.anim.nav_default_enter_anim,
							cz.cleevio.core.R.anim.nav_default_exit_anim,
							cz.cleevio.core.R.anim.nav_default_pop_enter_anim,
							cz.cleevio.core.R.anim.nav_default_pop_exit_anim
						)
				...
				selectedNavController.value?.addOnDestinationChangedListener(destinationChangedListener)
